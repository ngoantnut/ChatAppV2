...
/*Hiển thị danh sách story*/
    ...
    //Kiểm tra trạng thái online ở đây
    @Override
...
/*Make groups chat*/
    private void RequestNewGroup() {
        ...
        groupNameField.setHint("VD: Nhóm nhậu");
        ...
        builder.setPositiveButton("Tạo", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(TextUtils.isEmpty(groupName)){
                    Toast.makeText(MainActivity.this, "Tên nhóm không được để trống", Toast.LENGTH_SHORT).show();
                }
                else {
